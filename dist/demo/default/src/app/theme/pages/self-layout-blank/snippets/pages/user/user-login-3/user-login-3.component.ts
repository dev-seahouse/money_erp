...
export class UserLogin3Component implements OnInit, AfterViewInit {
  ...
  ngAfterViewInit() {
    ...
    Helpers.bodyClass('m--skin- m-header--static m-header--fixed-mobile m-aside-left--enabled m-aside-left--skin-dark m-aside-left--fixed m-aside-left--offcanvas m-footer--push m-aside--offcanvas-default');
